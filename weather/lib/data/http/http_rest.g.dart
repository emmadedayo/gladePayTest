...
class _RestClient implements RestClient {
  ...
  Future<CurrentLocation> getCurrentLocationWeather(
    ...
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<CurrentLocation>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
            .compose(
              _dio.options,
              '/current.json?key=${apiKey}&q=${q}&aqi=${aqi}',
  ...
  Future<ForCastResponseEntity> getForecastLocationWeather(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<ForCastResponseEntity>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<List<LocationSearch>> getSearchLocationWeather(
    ...
    final _data = <String, dynamic>{};
    final _result = await _dio
        .fetch<List<dynamic>>(_setStreamType<List<LocationSearch>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
